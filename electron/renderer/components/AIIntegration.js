      ...
      <div class="card" style="margin-bottom:16px;">
        ...
        <div style="font-size:12px;line-height:1.7;color:var(--text-secondary);">
          ...
          <details><summary style="cursor:pointer;font-weight:600;">inspect_runtime and preview_entity tools don't work</summary>
            <p style="margin:4px 0 0 16px;">These tools require the optional <code>BridgeInspector.js</code> plugin to be installed in your RPG Maker project and running in-game. Copy the plugin from HeroLink's <code>js/plugins/BridgeInspector.js</code> to your project's <code>js/plugins/</code> folder, add it to your plugin list, and start the game. All other tools work without it.</p></details>
